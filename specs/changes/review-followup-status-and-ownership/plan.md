...
1. Refresh the canonical project-status baseline and add HTTP contract truth restoration as a separate v1 blocker before provider/deployment acceptance.
...
4. Route the documentation index through the canonical status and review overlay while retaining the historical review documents for audit context.
