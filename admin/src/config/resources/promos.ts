...
export const promosResource: ResourceDef = {
  ...
  cols: [
    ...
    { k: 'usage_limit', l: '限次', r: 'number' },
    { k: 'used_count', l: '已用', r: 'number' },
    ...
    sections: [
      {
        ...
        fields: [
          ...
          { k: 'type', l: '類型', w: 'select', opts: ['percent', 'fixed', 'freeshipping'],
            help: 'percent=百分比折扣；fixed=固定金額；freeshipping=免運' },
          { k: 'value', l: '數值', w: 'number', help: 'percent 為 1-100；freeshipping 可留 0' },
          { k: 'min_subtotal', l: '最低消費（0=不限）', w: 'number' },
          { k: 'usage_limit', l: '使用上限（0=不限）', w: 'number' },
