...
export const productsResource: ResourceDef = {
  ...
  pinActions: true,
  cols: [
    { k: 'sku', pin: 'left', l: 'SKU', r: 'mono' },
    { k: 'name', l: '商品', sortable: true },
    ...
    { k: 'stock', l: '庫存', r: 'number', sortable: true },
    { k: 'sold_count', l: '售出', r: 'number', sortable: true },
    ...
    sections: [
      {
        ...
        fields: [
          ...
          { k: 'long_description', l: '詳細說明', w: 'textarea', span: 2 },
          { k: 'category', l: '分類', w: 'select', optsSource: { api: '/admin/categories', listKey: 'categories', value: 'slug', label: 'name' } },
          { k: 'status', l: '狀態', w: 'select', opts: ['draft', 'active'] },
          { k: 'is_featured', l: '精選（首頁）', w: 'switch' },
      ...
      },
      {
        t: '規格變體',
        fields: [
          { k: 'variants', l: '規格（尺寸/顏色等）', w: 'variants', span: 2,
            help: '每個規格有獨立 SKU、價差與庫存。前台商品頁會出現規格選擇器。' },
        ],
      },
    ],
  },
