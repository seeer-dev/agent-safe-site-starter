...
ALTER TABLE site_content ADD COLUMN IF NOT EXISTS published_title TEXT NOT NULL DEFAULT '';
ALTER TABLE site_content ADD COLUMN IF NOT EXISTS published_body TEXT NOT NULL DEFAULT '';
ALTER TABLE site_content ADD COLUMN IF NOT EXISTS published_updated_unix INTEGER NOT NULL DEFAULT 0;
