...
CREATE TABLE media_assets (
    ...
    verified_unix BIGINT NOT NULL,
    reservation_token TEXT NOT NULL DEFAULT '',
    reserved_unix BIGINT NOT NULL DEFAULT 0,
    unassociated_since_unix BIGINT NOT NULL DEFAULT 0,
...
CREATE TABLE media_gc_jobs (
    ...
    last_attempt_unix BIGINT NOT NULL DEFAULT 0
);
