...
ALTER TABLE site_content ADD COLUMN IF NOT EXISTS published_key TEXT NOT NULL DEFAULT '';
ALTER TABLE site_content ADD COLUMN IF NOT EXISTS published_placement TEXT NOT NULL DEFAULT '';
ALTER TABLE site_content ADD COLUMN IF NOT EXISTS published_sort_order INTEGER NOT NULL DEFAULT 0;
