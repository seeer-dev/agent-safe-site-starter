...
Do not introduce runtime multi-site selection, dynamic module selection, global service lookup, speculative provider registries, dynamic plugins, or a runtime DI container to prepare for hypothetical future sites.
...
2. bootstrap owns the adapter and wiring;
